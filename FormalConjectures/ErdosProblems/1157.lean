...
/-- Brown-Erdős-Sós Conjecture: For all r > t ≥ 2 and s ≥ 3,
    ...
    The actual statement should define ex_t as the extremal number function
    and prove its asymptotic behavior. -/
...
/-- Known lower bound: For all k > r and s > 1,
    ...
    NOTE: The existential quantifier over ex makes this trivially satisfiable.
    The actual statement should define ex_r as the extremal number function
